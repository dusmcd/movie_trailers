...
oceans_eleven = media.Movie("Ocean's Eleven",
                    "Danny Ocean and his crew take on a nearly-impossible "
                    "casino heist.",
...
walter_mitty = media.Movie("The Secret Life of Walter Mitty",
                          "While on the verge of losing his job, Walter Mitty "
                           "embarks on an exciting journey.",
...
#Call the open_movies_page method from the fresh_tomatoes file that will create the html file that displays data in this file
